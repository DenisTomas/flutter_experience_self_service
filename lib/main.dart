...
import 'package:fe_lab_clinicas_self_service/src/modules/auth_modules.dart';
import 'package:fe_lab_clinicas_self_service/src/modules/home/home_module.dart';
import 'package:fe_lab_clinicas_self_service/src/pages/splashPage/splash_page.dart';
...
class LabClinicasSelfServiceApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LabClinicasCoreConfig(
      ...
      modules: [AuthModules(),HomeModule()],
    );
  }
}
